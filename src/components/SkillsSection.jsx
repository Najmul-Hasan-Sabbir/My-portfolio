...
const skills = [
  ...
  { name: "C++ (DSA)", level: 90, category: "core" },
  ...
  { name: "SQL", level: 85, category: "data-science" },
  ...
  { name: "Tableau", level: 70, category: "data-science" },
  { name: "Docker", level: 60, category: "tools" },
];

const categories = ["all", "core", "frontend", "backend", "data-science", "tools"];
